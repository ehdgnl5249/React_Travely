...
function Post({ post, handleLike }) {
  ...
  return (
    <div style={{ marginBottom: "2em", width: "600px", maxHeight: "700px" }}>
      {/* 간편 리뷰 게시물 */}
      {is_quick === true && (
        <Card
        ...
        >
          ...
          <br />
          <br />
          <span style={{ fontSize: "14px", fontWeight: "bold" }}>좋아요 </span>
          <span style={{ fontSize: "14px" }}>{like_user} </span>
          <span style={{ fontSize: "14px", fontWeight: "bold" }}>개</span>
          <br />
          <Rate
            allowHalf
            disabled
